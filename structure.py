...
def montarRanking(linha):
    ...
    ranking['preco'] = dados[2].replace("R$ ", "").replace(".", "").replace(",", ".")
    ranking['liquidez'] = dados[3]
    ranking['dividendo'] = dados[4]
    ranking['dividend_yield'] = dados[5].replace(",", ".").replace("%", "")
    ranking['dividend_yield_3'] = dados[6].replace(",", ".").replace("%", "")
    ranking['dividend_yield_6'] = dados[7].replace(",", ".").replace("%", "")
    ranking['dividend_yield_12'] = dados[8].replace(",", ".").replace("%", "")
    ranking['dividend_yield_media_3'] = dados[9].replace(",", ".").replace("%", "")
    ranking['dividend_yield_media_6'] = dados[10].replace(",", ".").replace("%", "")
    ranking['dividend_yield_media_12'] = dados[11].replace(",", ".").replace("%", "")
    ranking['dividend_yield_ano'] = dados[12].replace(",", ".").replace("%", "")
    ...
    ranking['P/VPA'] = dados[18].replace(",", ".")
